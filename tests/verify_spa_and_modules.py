...
def run_comprehensive_audit():
    ...
    with sync_playwright() as p:
        ...
        for menu in menu_checks:
            ...
            # Assert shell wasn't destroyed and 0 new document requests were made
        ...
        # Verify request count did not increment because TTL is active and keep-alive kept cache
        ...
        if error_has_retry:
            simulate_500["customer"] = False
            # Clear search to allow full customer list on recovery
        ...
        # Save results in in-repo audit directory
        out_file = OUT / "comprehensive_audit_results.json"
