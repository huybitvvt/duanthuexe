  ...
  >
      ...
      <div class="row">
        ...
        <div class="col-md-6 form-group">
          ...
          <el-input
            ...
            type="number"
          />
          <small class="form-text text-muted">Nhập 0 nếu đổi xe cùng hạng giá.</small>
        </div>
    ...
    <template #modal-footer="{ cancel }">
      ...
      <b-button variant="warning" :disabled="loading" @click="handleSubmit">
        <i class="fas fa-exchange-alt mr-1"></i> Xác nhận đổi xe & Lập phụ lục
      </b-button>
    </template>
  </b-modal>
</template>
...
export default {
  ...
  methods: {
    open(orderId = null, oldVehicle = null, storeId = null) {
      ...
      this.fetchReadyVehicles(storeId || this.defaultStoreId);
    },
    ...
    handleSubmit() {
      ...
      this.loading = true;
      this.$store
        .dispatch(WAREHOUSE_EXCHANGE_VEHICLE, {
          ...
          price_difference: Number(this.form.price_difference || 0),
