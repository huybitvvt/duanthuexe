        ...
        <b-modal id="modal-vehicle-edit" title="Sửa thông tin xe" size="xl" ok-title="Cập nhật" ok-only @ok="handleOk">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Hãng xe</label>
                        <ValidationProvider vid="store_id" name="Hãng xe" rules="required" v-slot="{ errors, classes }">
                            <el-select filterable class="w-100" placeholder="Hãng xe" v-model="vehicle.brand" clearable
                                :class="classes">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Tên xe</label>
                        <ValidationProvider vid="store_id" name="Tên xe" rules="required" v-slot="{ errors, classes }">
                            <el-input clearable placeholder="Tên xe" v-model="vehicle.name" :class="classes"></el-input>
                            <div class="fv-plugins-message-container">
                                <div data-field="name" data-validator="notEmpty" class="fv-help-block">
                                    {{ errors[0] }}
                                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <ValidationProvider vid="store_id" name="Cừa hàng" rules="required"
                            ...
                            <el-select filterable class="w-100" placeholder="Cửa hàng" v-model="vehicle.store_id"
                                clearable :class="classes">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <ValidationProvider vid="status" name="Trạng thái" rules="required"
                            v-slot="{ errors, classes }">
                            <el-select filterable class="w-100" placeholder="Trạng thái" v-model="vehicle.status"
                                clearable :class="classes">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <ValidationProvider vid="year" name="Năm sản xuất" rules="required"
                            v-slot="{ errors, classes }">
                            <el-select filterable class="w-100" placeholder="Năm sản xuất" v-model="vehicle.year"
                                clearable :class="classes">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Loại xe</label>
                        <ValidationProvider vid="type" name="Loại xe" rules="required" v-slot="{ errors, classes }">
                            <el-select filterable class="w-100" placeholder="Loại xe" v-model="vehicle.type" clearable
                                :class="classes">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Biển số</label>
                        <ValidationProvider vid="license" name="Biển số" rules="required" v-slot="{ errors, classes }">
                            <el-input clearable placeholder="Biển số" v-model="vehicle.license"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <ValidationProvider vid="chassis" name="Số khung" rules="required" v-slot="{ errors }">
                            <el-input clearable placeholder="Số khung" v-model="vehicle.chassis"></el-input>
                            <div class="fv-plugins-message-container">
                                <div data-field="name" data-validator="notEmpty" class="fv-help-block">
                                    {{ errors[0] }}
                                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Số máy</label>
                        <ValidationProvider vid="engine" name="Số máy" :rules="{ required: true }" v-slot="{ errors }">
                            <el-input clearable placeholder="Số máy" v-model="vehicle.engine"></el-input>
                            <div class="fv-plugins-message-container">
                                <div data-field="name" data-validator="notEmpty" class="fv-help-block">
                                    {{ errors[0] }}
                                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Màu</label>
                        <ValidationProvider vid="color" name="Màu" :rules="{ required: true }" v-slot="{ errors }">
                            <el-input clearable placeholder="Màu" v-model="vehicle.color"></el-input>
                            <div class="fv-plugins-message-container">
                                <div data-field="name" data-validator="notEmpty" class="fv-help-block">
                                    {{ errors[0] }}
                                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <ValidationProvider vid="type_of_service_id" name="Phân loại" :rules="{ required: true }"
                            v-slot="{ errors }">
                            <el-select filterable class="w-100" placeholder="Phân loại"
                                v-model="vehicle.type_of_service_id" clearable @change="changeTypeOfService">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Giá mua</label>
                        <ValidationProvider vid="cost_price" name="Giá mua" :rules="{ required: true }"
                            v-slot="{ errors, classes }">
                            <money v-model="vehicle.cost_price" class="form-control" :class="classes" v-bind="money">
                            </money>
                ...
                <div class="col-md-4" v-if="is_show_price_sell">
                    <div class="form-group">
                        ...
                        <ValidationProvider vid="price_min" name="Giá bán tối thiểu" :rules="{ required: true }"
                            v-slot="{ errors, classes }">
                            <money v-model="vehicle.price_min" class="form-control" :class="classes" v-bind="money">
                            </money>
                            <div class="fv-plugins-message-container">
                                <div data-field="name" data-validator="notEmpty" class="fv-help-block">
                                    {{ errors[0] }}
                ...
                <div class="col-md-4" v-if="is_show_price_sell">
                    <div class="form-group">
                        ...
                        <ValidationProvider vid="price_max" name="Giá bán tối đa" :rules="{ required: true }"
                            v-slot="{ errors, classes }">
                            <money v-model="vehicle.price_max" class="form-control" :class="classes" v-bind="money">
                            </money>
                            <div class="fv-plugins-message-container">
                                <div data-field="name" data-validator="notEmpty" class="fv-help-block">
                                    {{ errors[0] }}
            ...
            <div class="row">
                <div class="col-md-12 mb-4 mt-5">
                    <h5 class="text-primary">Cài đặt bảo dưỡng riêng</h5>
                </div>
                <div class="col-md-12">
                    <div>
                        <div v-for="(item, key) in maintenance_settings" :key="key">
                            <maintenance-setting :index="key" :item="item" @deleteSetting="deleteSetting">
                            </maintenance-setting>
                        </div>
...
import { VEHICLE_UPDATE } from "../../../core/services/store/vehicle.module";
...
export default {
    ...
    components: {
        MaintenanceLog, MaintenanceSetting
    },
    props: {
        item: {
            types: Object,
    ...
    data() {
        return {
            ...
            maintenance_settings_to_destroy: [],
    ...
    methods: {
        ...
        updateVehicle() {
            this.vehicle.maintenance_settings = this.maintenance_settings;
            this.vehicle.maintenance_settings_to_destroy = this.maintenance_settings_to_destroy;
 
            this.$store
                .dispatch(VEHICLE_UPDATE, this.vehicle)
                .then(() => {
                    ...
                    this.$bvModal.hide("modal-vehicle-edit");
                })
                .catch((e) => {
                    this.$notify({
