<template>
    <div>
        <button v-b-modal.modal-order-create class="btn btn-success btn-sm">
            Thêm mới
        </button>
        <b-modal
...
export default {
    ...
    methods: {
        ...
        storeOrderSell() {
            this.$store
                .dispatch(ORDER_SELL_CREATE, this.order)
                .then(() => {
                    ...
                    this.$nextTick(() => {
                        this.$bvModal.hide("modal-order-create");
                    });
                })
                .catch((e) => {
                    this.$notify({
